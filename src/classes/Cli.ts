  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        else if (answers.action === 'Tow vehicle (Truck Only)') {
          const truck = this.vehicles.find((v) => v.vin === this.selectedVehicleVin) as Truck;
        ...
        else if (answers.action === 'Perform wheelie (Motorbike only)') {
          const motorbike = this.vehicles.find((v) => v.vin === this.selectedVehicleVin) as Motorbike;
